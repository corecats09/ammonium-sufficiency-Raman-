...
subplot (331)
histogram (param_log_wt(4,:),20,'Normalization','probability')
ylabel ('dna')
title ('wt')
subplot (334)
histogram (param_log_wt(2,:),20,'Normalization','probability')
ylabel ('rna')
subplot (337)
histogram (param_log_wt(4,:),20,'Normalization','probability')
ylabel ('prt')
...
subplot (332)
histogram (param_log_glnb(4,:),20,'Normalization','probability')
title ('glnb')
subplot (335)
histogram (param_log_glnb(2,:),20,'Normalization','probability')
subplot (338)
histogram (param_log_glnb(1,:),20,'Normalization','probability')
xlabel ('intensity/counts')
subplot (333)
histogram (param_log_glnk(4,:),20,'Normalization','probability')
title ('glnk')
subplot (336)
histogram (param_log_glnk(2,:),20,'Normalization','probability')
subplot (339)
histogram (param_log_glnk(1,:),20,'Normalization','probability')
xlabel ('intensity/counts')
```
![distr log wt glnb glnk](figures/distr1.jpg)

```matlab
% N run-out:

subplot (331)
histogram (param_ro_wt(4,:),20,'Normalization','probability')
ylabel ('dna')
title ('wt')
subplot (334)
histogram (param_ro_wt(2,:),20,'Normalization','probability')
ylabel ('rna')
subplot (337)
histogram (param_ro_wt(4,:),20,'Normalization','probability')
ylabel ('prt')
xlabel ('intensity/counts')
subplot (332)
histogram (param_ro_glnb(4,:),20,'Normalization','probability')
title ('glnb')
subplot (335)
histogram (param_ro_glnb(2,:),20,'Normalization','probability')
subplot (338)
histogram (param_ro_glnb(1,:),20,'Normalization','probability')
xlabel ('intensity/counts')
subplot (333)
histogram (param_ro_glnk(4,:),20,'Normalization','probability')
title ('glnk')
subplot (336)
histogram (param_ro_glnk(2,:),20,'Normalization','probability')
subplot (339)
histogram (param_ro_glnk(1,:),20,'Normalization','probability')
xlabel ('intensity/counts')
```
![distr ro wt glnb glnk](figures/distr2.jpg)

```matlab
% N starvation:

subplot (331)
histogram (param_sta_wt(4,:),20,'Normalization','probability')
ylabel ('dna')
title ('wt')
subplot (334)
histogram (param_sta_wt(2,:),20,'Normalization','probability')
ylabel ('rna')
subplot (337)
histogram (param_sta_wt(4,:),20,'Normalization','probability')
ylabel ('prt')
xlabel ('intensity/counts')
subplot (332)
histogram (param_sta_glnb(4,:),20,'Normalization','probability')
title ('glnb')
subplot (335)
histogram (param_sta_glnb(2,:),20,'Normalization','probability')
subplot (338)
histogram (param_sta_glnb(1,:),20,'Normalization','probability')
xlabel ('intensity/counts')
subplot (333)
histogram (param_sta_glnk(4,:),20,'Normalization','probability')
title ('glnk')
subplot (336)
histogram (param_sta_glnk(2,:),20,'Normalization','probability')
subplot (339)
histogram (param_sta_glnk(1,:),20,'Normalization','probability')
xlabel ('intensity/counts')
```
![distr sta wt glnb glnk](figures/distr3.jpg)

```matlab
% N up-shift

subplot (331)
histogram (param_upsft_wt(4,:),20,'Normalization','probability')
ylabel ('dna')
title ('wt')
subplot (334)
histogram (param_upsft_wt(2,:),20,'Normalization','probability')
ylabel ('rna')
subplot (337)
histogram (param_upsft_wt(4,:),20,'Normalization','probability')
ylabel ('prt')
xlabel ('intensity/counts')
subplot (332)
histogram (param_upsft_glnb(4,:),20,'Normalization','probability')
title ('glnb')
subplot (335)
histogram (param_upsft_glnb(2,:),20,'Normalization','probability')
subplot (338)
histogram (param_upsft_glnb(1,:),20,'Normalization','probability')
xlabel ('intensity/counts')
subplot (333)
histogram (param_upsft_glnk(4,:),20,'Normalization','probability')
title ('glnk')
subplot (336)
histogram (param_upsft_glnk(2,:),20,'Normalization','probability')
subplot (339)
histogram (param_upsft_glnk(1,:),20,'Normalization','probability')
xlabel ('intensity/counts')
```
![distr upsft wt glnb glnk](figures/distr4.jpg)
